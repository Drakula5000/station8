...
| script | what it does |
|:---|:---|
| `scheduled_backup.py` | Snapshots all Supabase data rows to timestamped backups. Runs automatically every 2 hours via GitHub Actions. |
| `backup_supabase.py` | One-shot manual backup. |
